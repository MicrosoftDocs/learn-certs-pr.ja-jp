...
- [your certification dashboard](https://www.microsoft.com/learning/dashboard.aspx) にサインインする。
...
スコア レポートには、[your certification dashboard](https://www.microsoft.com/learning/dashboard.aspx) からアクセスできます。

- [your certification dashboard](https://www.microsoft.com/learning/dashboard.aspx) にサインインする。
- [**スコア レポートを表示**] を選択する。ここから、スコア レポートを保存、印刷できます。
...
試験を開始するには、[your certification dashboard](https://www.microsoft.com/learning/dashboard.aspx)  にサインインし、[**以前に予約済みのオンライン試験監督付きオンライン試験を開始する**]をクリックします。スケジュールされた試験を確認できる Pearson VUE ページが開き、試験を開始できます。
